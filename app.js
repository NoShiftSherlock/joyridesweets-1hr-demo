/* Joyride × Vesper Commerce — 1-hour delivery mockup interactions */

// ---------- Product catalog (homepage grid) ----------
const PRODUCTS = [
  {
    "line": "",
    "name": "1.8 oz watermelon wedges (8-pack)",
    "img": "assets/p0.jpg",
    "price": "$24.00",
    "status": "",
    "rating": "",
  ...
  {
    "line": "",
    "name": "Idaho Potato Wedges - 5 Pack",
    "img": "assets/p1.png",
    "price": "$25.00",
    "status": "",
    "rating": "",
  ...
  {
    "line": "",
    "name": "sour blue raspberry strips",
    "img": "assets/p4.png",
    "price": "$30.00",
    "status": "",
    "rating": "",
  ...
  {
    "line": "",
    "name": "sour pink lemonade strips",
    "img": "assets/p7.png",
    "price": "$30.00",
    "status": "",
    "rating": "",
...
// ---------- On-demand catalog (Joyride Now page) ----------
const NOW_PRODUCTS = [
  {
    "line": "",
    "format": "Single",
...
// Joyride Now address check -> reveal grid
function nowCheck() {
...
function setMode(mode) {
  ...
  if (addBtn && !isOneHr) {
    addBtn.textContent = mode === "subscribe" ? "Subscribe — $21.60" : "Add to cart — $24.00";
  }
}
function pdpCheck() {
...
const CO = { subtotal: 48.00, tax: 4.26, ship: 7.0, shipLabel: "1-Hour delivery" };
...
function placeOrder() {
  ...
  toast(oneHr ? "Order placed ⚡ Routing to nearest store — arriving in ~52 min"
              : "Order placed ✓ Thanks — your Joyride order is confirmed.");
}
document.addEventListener("DOMContentLoaded", updateCheckoutTotals);

// ---------- Slide-out cart drawer + rewards meter ----------
const CART = {"name": "1.8 oz watermelon wedges (8-pack)", "line": "", "img": "assets/p0.jpg", "unit": 24.0, "qty": 2, "sub": false};
const TIERS = [
...
function injectMobileMenu() {
  ...
  const active = location.pathname.endsWith("joyridesweets-now.html") ? "brand-now" : "";
  const wrap = document.createElement("div");
  wrap.innerHTML = `
    <div class="menu-overlay" id="menuOverlay" onclick="closeMenu()"></div>
    <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
      <div class="mm-head">
        <span class="wordmark">Joyride</span>
      ...
      <div class="mm-links">
        ...
        <a href="joyridesweets-now.html" class="${active === "brand-now" ? "active" : ""}">Joyride Now</a>
      </div>
      <div class="mm-cta"><a href="joyridesweets-now.html" class="btn btn-white btn-block">⚡ Check your address</a></div>
      <div class="mm-sub">
